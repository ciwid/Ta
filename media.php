...
<div class="plugin">             
              <div id="fb-root"></div>
              <div class="fb-like-box" data-href="#" data-width="289" data-show-faces="true" data-stream="false" data-header="true"></div>
</div>            </div>
      </div>
    ...
    <div class="page">
        ...
        <div class="copyright">
              <ul>
            <li>&copy; 2020 </li>
            <li><a href="#" class="select">UD.Alfan</a> All Rights Reserved.</li>
            <li><a href="#" class="select"> Bahan TA </a> All Rights Reserved.</li>
            <li class="last"></li>
          </ul>
            </div>
